...
class HomeScreen extends Component {
  ...
  handleGoToday = () => {};
  handleToday = () => {
    this.props.navigation.navigate('TotalTodayPayment');
  };
  handleTotal = () => {
            ...
            <Touchable
              ...
              <View
                ...
                <MaterialCommunityIcons
                  ...
                  style={styles.iconRow}
                />
                <Text style={{fontSize: wp(2.8), color: '#fff'}}>Offline</Text>
                {/* <Entypo
                      name="dot-single"
                      color="#999"
                      size={36}
            ...
            <Touchable
              ...
              <View
                ...
                <MaterialCommunityIcons
                  ...
                  style={styles.iconRow}
                />
                <Text style={{color: '#fff', fontSize: wp(2.8)}}>Offline</Text>
                {/* <Entypo
                      name="dot-single"
                      color="#999"
                      size={36}
  ...
  color: '#fff',}}>
              ...
              <Touchable
                ...
                <View
                  style={[basicStyles.directionRow, basicStyles.alignCenter,{ width: wp(5) }]}>
