...
class callPopUp extends PureComponent {
  ...
  //* MuteAudio
  pauseAudio = async () => {
    console.log('Mute audio doctor audio');
    await this._engine?.muteLocalAudioStream(true);
    this.setState({muteAudio: true});
  };
  //* start Audio
  startAudio = async () => {
    console.log('Unmute audio doctor audio');
  ...
  handleMuteVideo = async () => {
    try {
      console.log('mute audio doctor speaker');
  ...
  handleUnMuteVideo = async () => {
    try {
      console.log('unmute audio doctor speaker');
