...
class CallBalancePopup extends PureComponent {
  ...
  handleMuteVideo = async () => {
    try {
      console.log('mute audio client speaker');
  ...
  handleUnMuteVideo = async () => {
    try {
      console.log('unmute audio client speaker');
    ...
    try {
      ...
      if (response) {
        ...
        if (success) {
          ...
          this.closeOldPop();
      Alert.alert('Aapke Pass',`${message}\n\n\Thank you for using Aapke Paas!`);
        } else {
          this.closeOldPop();
            ...
            <View style={styles.listContainerMain00}>
              ...
              <View style={styles.listContainer2}>
                <Ionicons
                  ...
                  style={styles.iconRow}
                />
                <Text style={{flex: 1}}>Max time est. to available call</Text>
